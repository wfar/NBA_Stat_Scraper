'''Program scrapes and presents NBA stats for all players from basketball-reference.com'''
...
def get_connection():
    # Checks if connection to site is made. NOT IN USE
    try:
...
def get_player_page():
    ...
    url = 'http://www.basketball-reference.com/players/'
    player_last = input('Enter LAST name of player: ')
    player_first= input('Enter FIRST name of plater: ')
...
def get_player_stats(player_url):
    # Connects to player's url page. Scrapes stats into lists.
    p1 = []
    p2 = []
    p3 = []
    source = requests.get(player_url).text
...
def present_stats(current_dict, career_dict):
    # Prints all player stats in a clean and ordered format.
    
    data_0 = '{:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8}'.format('','G','PTS','TRB','AST','FG%',
                                                                                        'FG3%','FT%','eFG%','PER','WS')
    spacer = '{:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8}'.format('','----','----','----','----',
                                                                                        '----','----','----','----','----','----')
        
    data_1 = '{:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8}'.format('Current:',current_dict.get('G'),current_dict.get('PTS'),
    ...
    data_2 = '{:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8} {:^8}'.format('Career:',career_dict.get('G'),career_dict.get('PTS'),
